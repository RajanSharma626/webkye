                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <img src="../assets/images/review/<?php echo $row['profile'] ?>" alt=""
                                        ...
                                        <div class="d-flex align-items-center">
                                            <img src="../assets/images/review/<?php echo $row['country'] ?>"
                                                alt="country_flag" class="avatar-sm rounded" style="width: 20px;"> &nbsp;
